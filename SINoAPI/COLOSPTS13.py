...
async def get_user_active():
    ...
    await cur.execute("SELECT * from user where active  and ts = 13")
...
async def starting():
    async with aiohttp.ClientSession() as session:
        ...
        e = Embed(title="Auto-SP", description="Starting Astellia Auto-SP")
...
def ending():
    ...
    e = Embed(title="Auto-SP", description="Terminating Astellia Auto-SP")
