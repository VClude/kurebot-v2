...
UUID_PAYMENT = '8595236268358498ae9b97f32c334cebdc112466e37fc45' # app id + payment uuid.
AES_KEY = b'E0pBnbdmU9+rLfQ4' # RE with IDA or Frida
SESSION_ID = '86b121e8e3891dba2b4b9d1b062da2ff' # 32 bytes string, changes every time you enter the game
USER_ID = 988358480 # 9 bytes int
PRIV_KEY = '' # 460 bytes string
...
async def main():
    while True:
        ...
        dat = json.loads(a)
        print("Watching : " + dat["payload"]["userData"]["name"] + " | " + str(dat["payload"]["userData"]["stamina"]) + " AP" + " | " + str(dat["payload"]["userData"]["money"]) + " Gold", end='\r')
