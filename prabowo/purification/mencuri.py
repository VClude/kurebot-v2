...
from configacc2 import APP_VERSION, UUID_PAYMENT, SESSION_ID, USER_ID, PRIV_KEY, AES_KEY
...
class Purification():
    ...
    def getEvent(self):
        r = self.api.POST__api_guild_get_event_data()
        df = open("eventtempest.json", "w")
